...
public interface ScheduleApi {
    ...
    @POST("schedule/")
    Single<ScheduleResponse> createSchedule(@Body LecturerRequest request);

    @GET("schedule/{schedule}/")
    Single<ScheduleResponse> getScheduleById(@Path("schedule") Integer lecturerId);

    @PUT("schedule/{schedule}/")
    Single<ScheduleResponse> updateSchedule(@Body LecturerRequest request, @Path("schedule") Integer lecturerId);
